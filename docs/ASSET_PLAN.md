...
| 6 | 버스·승용차·배달 밴 | `world/Traffic.tsx` | 800~1500 / 512² 아틀라스 |
...
| | 원본 | 반입 후 | 기준 |
|---|---:|---:|---:|
| 파일 | 117~120MB | 59~73KB | 350KB |
| 삼각형 | 3,029,904 | 2,362~2,538 | 800~1,500 |
| 텍스처 | 알베도+노멀+메탈러프 | 알베도 512² webp | 알베도 512² |

**아직 기준에 못 미치는 것 셋.** 삼각형이 1.7배 남았고, 바퀴가 차체와 한 메시라
반입 규칙 2항(바퀴 네 개 분리)을 못 지켰으며, 셋이 각자 텍스처를 들고 있어
4항(아틀라스·머티리얼 공유)도 못 지켰다. 셋 다 단순화 옵션으로는 안 되고
DCC 작업이 필요하다.
