...
describe("검사를 끄는 주석", () => {
  ...
  it("억제가 조용히 늘지 않는다", () => {
     ...
     */
    /*
     * 한때 9였다(2026-08-24). 아홉 번째는 「빛으로 여는 문」이었는데, 그 기능을
     * 통째로 걷어내면서 함께 사라졌다 — 잠긴 문을 열쇠로 여는 구조가 이 게임의
     * 모양(대화로 이야기가 흐르고 싸움은 바깥에서 일어난다)과 장르가 달랐다.
     *
     * **한도는 기능이 사라지면 함께 내린다.** 안 내리면 다음에 억제 하나가
     * 조용히 들어와도 검사가 통과한다 — 자리가 비어 있기 때문이다.
     */
    /*
